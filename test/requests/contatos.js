...
describe('No controller contatos', () => { //DESCRIBE É APENAS UMA FUNÇÃO PARA DESCREVER O CASO DE TESTE
    describe('usuario nao logado', () => {
        it('GET "/contatos" redireciona para GET "/"', (done)=> { //IT É O NOME DO CASO DE TESTE A SER EXECUTADO
